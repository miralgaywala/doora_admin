 <section class="content">
      <div class="row">
        <div class="col-md-10" style="float: left;margin-bottom: 10px;"> <h2>Edit Customer Image</h2></div>
        <div class="col-md-2">
                <br/>   
       ...
       <div class="alert alert-info alert-dismissible" id="exists" style="display: none;">
                 <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                   Customer image has been uploaded successfully
                 </div>    
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                <form class="form-horizontal" name="addcategory" id="addcategory_form" role="form" action="" method="post" enctype="multipart/form-data" >
                            <div class="form-group notranslate">
                                <label for="category_image" class="col-sm-3 control-label">Customer Image<span class="show_required">*</span></label>
                                    <div class="col-sm-8">
                                        ...
                                        <input type="hidden" name="customer_img_value" id="customer_img_value">
                                      ...
                                      <div class="col-md-5" style="margin-top: 10px;">
                                        <?php $time = date("H:i:s"); ?>
                                        <div id="preview-crop-image" style="width:367px;height:366px;border-style: groove;border-width: thin;"><img src='../../../images/profile/customerdefault.jpg<?php echo "?time=".$time; ?>' style="width:364px;height:364px;" /></div>
...
<script type="text/javascript">
  ...
  {
     var data_img = $("#customer_img_value").val();
    if(data_img == "")
    {
      document.getElementById("category_imageerror").innerHTML="Please Select Image";
      topFunction();
    ...
    { 
              $.ajax({
                        url: "../../View/customer_image/croppie.php",
                        type: "POST",
                       //  cache: false,
                       //  contentType: false,
                       //  processData: false,

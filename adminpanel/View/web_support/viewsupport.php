...
<!--Main Content -->
    <section class="content">
      <div class="row">
        <div class="col-md-10" style="float: left;margin-bottom: 10px;"> <h2>View Web Customer Support</h2></div>
        <div class="col-md-2">
                <br/>   
               ...
               <button style="float: right;" onclick="backsupport()" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</button>

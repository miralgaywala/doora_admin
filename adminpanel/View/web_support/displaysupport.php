<script type="text/javascript">
  ...
  function listsupport(data)
      ...
      {
            $.ajax({
                 url:"../../Controller/web_support/displaysupport_controller.php?id="+id,
                 method:"POST",
                 success:function(data)
                 {
                      $('.content-wrapper').html(data);
    ...
    // })
      function loadactivefilter(){
       // console.log($('#year').val());
        ...
        $.ajax({
       url: '../../Controller/web_support/active_filter.php',
       data : {radio:radio},
       type: 'POST',
       success: function(data) {
        //console.log(data);
        	...
        	<div class="col-xs-12">
              ...
              <div class="col-sm-4"></div>
                  ...
                  <label class="radio-inline col-sm-2" style="margin-top: 25px;">
                        <input type="radio" name="optradio" id="active" checked value="all" onclick="loadactivefilter()" >All
                  </label>
                          <label class="radio-inline col-sm-2" style="margin-top: 25px;">
                        <input type="radio" name="optradio" id="active" value="open" onclick="loadactivefilter()" >Open
                  </label>
                <label class="radio-inline col-sm-2" style="margin-top: 25px;">
                        <input type="radio" name="optradio" id="active" value="close" onclick="loadactivefilter()" >Close
                  </label>
    ...
    buttons: {
      Yes: {
          ...
          action: function(){
            ...
            $.ajax({
                 url:"../../Controller/web_support/support_controller.php",
                 method:"POST",

                            ...
                            <div class="form-group notranslate">
                                <label for="profile_image" class="col-sm-3 control-label">Profile Image<span class="show_required">*</span></label>
                                    <div class="col-sm-8">
                                        ...
                                        <div id="AdminPicture" style="background-image:url('../../../images/profile/<?php echo $data['photo'];?>');margin:10px 0 0 0" ></div><br>
    ...
    function initMap()
            ...
            function validateForm() {
                                    ...
                                    if (company_name.trim() == "") {
                                        document.getElementById('company_name_error').innerHTML="Please Enter Tag Name";
                                        count++;
                                      }
                                      else
                                      {
                                      ...
                                      if (contact_number.trim() == "") {
                                        document.getElementById('contact_number_error').innerHTML="Please Enter Tag Name";
                                        count++;
                                      }
                                      else
                                      {
                                      ...
                                      if (website_url.trim() == "") {
                                        document.getElementById('website_url').innerHTML="Please Enter Tag Name";
                                        count++;
                                      }
                                      else
                                      {
                                      ...
                                      if (address.trim() == "") {
                                        document.getElementById('address_error').innerHTML="Please Enter Tag Name";
                                        count++;
                                      }
                                      else
                                      {

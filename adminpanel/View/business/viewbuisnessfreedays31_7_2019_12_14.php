        		...
        		<div class="box">
                  ...
                  <!-- <div class="form-group notranslate">
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <input name="free_days" type="number" id="free_days" class="form-control" min="0" value="<?php echo $data['free_trail_days']; ?>" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57"/>
 ...
 <script type="text/javascript">
                      ...
                      function validateForm() {
                                    ...
                                    if (free_days.trim() == "") {
                                      ...
                                      {
                                         document.getElementById('free_dayserror').innerHTML="Please Enter More Then 0 Days";
                                        count++;
                                      }
                                      else
                                      {

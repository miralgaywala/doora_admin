               ...
               <!--  <?php echo "<pre>"; print_r($result); echo "</pre>"; ?> -->
                ...
                <form class="form-horizontal" name="editbusiness" id="editbusiness" role="form" action="" method="post" enctype="multipart/form-data" >
                 <!--  <?php echo "<pre>"; print_r($result); echo "</pre>"; ?> -->
                           ...
                           <!--  <div class="form-group notranslate">
                                <label for="abn_acn" class="col-sm-3 control-label">ABN or ACN<span class="show_required">*</span></label>
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <input name="abn_acn" type="text" id="abn_acn" class="form-control" value="<?php echo $data['abn_number']; ?>" />
                                    <span id="abn_acn_error" class="show_required"></span>
                                </div>
                            </div> -->
                            <div class="form-group notranslate">
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
            ...
            function validateForm() {
                                    var profile_pic = document.getElementById("profile_pic").value; //profile_pic object
                                    var company_name = document.getElementById("company_name").value; // company_name object
                                    var contact_number = document.getElementById("phone").value; // contact number object
                                    var website_url = document.getElementById("website_url").value; // website_url
                                    // var abn_acn = document.getElementById("abn_acn").value;
                                    ...
                                    if (company_name.trim() == "") {
                                      ...
                                      // if (abn_acn.trim() == "") {
                                      //   document.getElementById('abn_acn_error').innerHTML="Please Enter ABN or ACN Number";
                                      //   count++;
                                      // }
                                      // else
                                      // {
                                      //   document.getElementById('abn_acn_error').innerHTML="";
                                      // }
                                      if (website_url.trim() == "") {

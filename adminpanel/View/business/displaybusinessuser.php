...
// include "../../View/header/sidemenu.php";
 // echo "<pre>"; print_r($display_businessuser); echo "</pre>";
                ...
                if($data['photo'] == NULL)
                 ...
                 else
                 {
                  $data['photo']= "default.png";
                    ...
                    $bnmae = $data['business_name'];
                    // $bnmae = json_decode(" \" $bnmae \" ");
                    // $bnmae = json_decode($bnmae);
                    // $bnmae = nl2br($bnmae);
                    // $bnmae = addslashes($bnmae);
                    // $bnmae = stripslashes($bnmae);           

                    $ownmae = $data['name'];
                    // $ownmae = json_decode(" \" $ownmae \" ");
                    // $ownmae = json_decode($ownmae);
                    // $ownmae = nl2br($ownmae);
                    // $ownmae = addslashes($ownmae);
                    // $ownmae = stripslashes($ownmae);           
                          ...
                          <?php $value=$data['is_deleted']; if($value == 0 ){
                           ...
                           ?> 
                            <tr>
                                ...
                                <td style="text-align:center;"><?php echo $ownmae; ?></td>
                                <td style="text-align:center;"><?php echo $bnmae; ?></td>

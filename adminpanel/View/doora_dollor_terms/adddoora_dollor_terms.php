    ...
    <script type="text/javascript">
      CKEDITOR.replace( 'doora_dollor_terms_desc' );
    </script> 
              ...
              <div class="box-body">
                <form class="form-horizontal" name="addtag" id="addtag" role="form" action="" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group notranslate">
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                  <textarea class="ckeditor" cols="80" id="doora_dollor_terms_desc" name="doora_dollor_terms_desc" rows="10" ><?php echo stripslashes($data['doora_dollar_tearms_desc']);?>
                                                 </textarea>
 ...
 <script type="text/javascript">
                      ...
                      function validateForm() {
                                    ...
                                    var doora_dollor_terms_desc = CKEDITOR.instances['doora_dollor_terms_desc'].getData();
                                  ...
                                  if(count>0)
                                   ...
                                   else
                                   {
                                      ...
                                      $.ajax({
                                           ...
                                           data : {
                                            count_id:count_id,
                                            doora_dollor_terms_title:doora_dollor_terms_title,
                                            doora_dollor_terms_desc:doora_dollor_terms_desc,
                                          },
                                           success:function(data)
                                           {
                                          console.log(data);

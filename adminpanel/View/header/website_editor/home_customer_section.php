...
<section class="content-header" id="app_div1"> 
  <h4>Update Home Customer Section</h4>
    ...
    <input type="hidden" name="hid" class="form-control" value="<?php echo $row['id']; ?>">
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <?php
             ...
             {
              ?>
                <img src="<?php echo IMAGE_SRC_PATH_NEW.$row['customer_section_image']; ?>?<?=rand(1,32000)?>" width="80%"  class="cimg1">
              <?php
             }
            ?>
          </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="btnname" class="form-control" value="<?php echo $row['customer_section_button_text']; ?>">
        </div>

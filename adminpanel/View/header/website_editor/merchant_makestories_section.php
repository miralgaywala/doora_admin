...
<section class="content-header" id="app_div1"> 
  <h4>Update Merchant Makestories Section</h4>
    ...
    <input type="hidden" name="hid" class="form-control" value="<?php echo $row['id']; ?>">
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" name="title" class="form-control" value="<?php echo $row['makestories_section_title']; ?>">
        </div>

        <div class="form-group">
          <label for="category">Description</label>
          <textarea id="editor2" name="desc" rows="10" cols="80"><?php echo $row['makestories_section_description']; ?></textarea>
        </div>

        <div class="form-group">
          <label for="category">Button Text</label>
          <input type="text" name="btnname" class="form-control" value="<?php echo $row['makestories_section_button_text']; ?>">
        </div>
...
function update()
{
  ...
  $.ajax({
      url : "website_editor/update_merchant_makestories_section.php",
      data:frdata,
      method:"post",
      processData:false,
      contentType:false,

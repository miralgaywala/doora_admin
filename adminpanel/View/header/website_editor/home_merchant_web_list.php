            ...
            <tr>
                <td>
                  <?php
                    ...
                    {
                      ?>
                      <img src="<?= NO_IMAGE_PATH ?>" width="120px" height="120px">
                      <?php
                    }
                    else
                    {
                ...
                <td><a href='javaScript:void(0);' onclick='edit_mer("<?php echo $res['id']; ?>");'> <i class='fa fa-edit' style="margin-top: 30px;margin-left: 10px"></i></a></td>
              </tr>
          <?php
        }
        ?>
...
<script type="text/javascript">
  function edit_mer(eid)
  {
    $.ajax({
         ...
         url : "website_editor/home_merchant_web.php",
          method:"post",
          data:{eid:eid},

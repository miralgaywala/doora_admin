...
$str = "select * from doora_doollars_about_web where id=".$_POST['eid'];
...
<section class="content-header" id="app_div1"> 
  <h4>Update Doora Doollars About Section</h4>
    <ol class="breadcrumb">
...
<section class="content">
  <div class="box" style="margin-top: -1px">
    <form role="form" method="post" enctype="multipart/form-data" id="dd_frm1">
      <div class="box-body">

        <div class="form-group">
          <label for="category">Image</label>
          <input type="file" class="form-control" name="image_1" value="<?php echo $row['image1']; ?>" id="cimg">
          <input type="hidden" class="form-control" name="ddid" value="<?php echo $row['id']; ?>">
        </div>
        ...
        <div class="box-footer">
          <button type="button"  class="btn btn-primary" onclick="update_web();">Submit</button>
           <input name="reset" type="reset" style="margin-left: 10px" value="Reset" onclick="resetForm('dd_frm1'); return false;" class="btn btn-default" />
        </div>
      </form>
  </div>
</section>
...
function update_web()
{
  ...
  $.ajax({
      url : "website_editor/update_doora_doollars_about_web.php",
      data:frdata,
      method:"post",
      processData:false,
      contentType:false,

        			...
        			<div class="box-body">
        				<form class="form-horizontal" name="addtag" id="addtag" role="form" action="" enctype="multipart/form-data" >
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <input name="doora_dollor_points_add" type="text" id="doora_dollor_points_add" class="form-control"/>
                             ...
                             <div class="form-group notranslate">
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <input name="points" type="text" id="points" class="form-control"/>
                                   ...
                                   else
                                   {
                                      var count_id = "add";
							            $.ajax({
							                 ...
							                 method:"POST",
							                 data : {count_id:count_id,doora_dollor_points:doora_dollor_points,code:code,description:description,points:points},
							                 success:function(data)
							                 {
                                console.log(data);
							                 	if(data == "#add")

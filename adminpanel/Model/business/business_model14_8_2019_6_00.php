...
class business_model
{
    ...
    public function edit_business($profile_pic,$company_name,$contact_number,$website_url,$address,$lat,$log,$user_id,$super_market,$pet_friendly)
    {
        ...
        $update=$con->query("update users SET business_name='".$company_name."', photo='".$profile_pic."' , mobile_no ='".$contact_number."', website_url='".$website_url."',address='".$address."',latitude='".$lat."',longitude='".$log."',is_super_market=".$super_market.",is_pet_friendly=".$pet_friendly.",updated_at='".$date."' where user_id=".$user_id);

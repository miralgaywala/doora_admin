<?php
include "../../Model/web_support/support_model.php";
...
class support_controller
{
	...
	public function display_support($msg)
	{
		...
		include "../../View/web_support/displaysupport.php";
	...
	public function view_support($support_id)
	{
		...
		include "../../View/web_support/viewsupport.php";
	...
	public function support_filter($support)
	{
		...
		include "../../View/web_support/filter_data.php";

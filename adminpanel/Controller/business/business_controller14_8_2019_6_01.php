...
if(isset($_POST['count_id']))
{
	...
	if($_POST['count_id'] == 'edit_business')
	{
		...
		$business_controller=new business_controller();
		$result=$business_controller->edit_business($profile_pic,$company_name,$contact_number,$website_url,$address,$lat,$log,$user_id,$super_market,$pet_friendly);
		if($result == 1)
		{
			echo "#update";
		}
...
class business_controller
{
	...
	public function edit_business($profile_pic,$company_name,$contact_number,$website_url,$address,$lat,$log,$user_id,$super_market,$pet_friendly)
	{
		$display_businessuser=$this->business_model->edit_business($profile_pic,$company_name,$contact_number,$website_url,$address,$lat,$log,$user_id,$super_market,$pet_friendly);

           ...
           function backsubcategory()
            ...
            $.ajax({
                 ...
                 success:function(data)
                 {
                       ...
                       pageurl = "../../Controller/sub_category/displaysubcategorycontroller.php";
                                  ...
                                  if(count>0)
                                   ...
                                   else
                                   {
                                      ...
                                      $.ajax({
                                        ...
                                        data: {count_id:count_id,sub_category_id,subcategoryname:subcategoryname,category_name:category_name,imagename:imagename},
                                        success: function (data) {

...
?> 
 ...
 <?php 
        include_once("../../Controller/offer_type/offer_controller.php");
        				...
        				<form class="form-horizontal" name="addoffer" id="addoffer_form" role="form" action="" method="post" onsubmit="return validateForm();">
                            ...
                            <?php } ?>                                             
                             <div class="box-footer  notranslate">
                                    ...
                                    <input type="button" class="btn btn-default pull-right" onclick="document.getElementById('addoffer_form').reset();window.location.href='../../Controller/offer_type/displayoffercontroller.php'" value="Cancel"></button>
                            </div>  
                           </div>
                         </form>
        			</div>

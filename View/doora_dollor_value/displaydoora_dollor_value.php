...
<script type="text/javascript">
  ...
  function addtag()
      ...
      function editdoora_dollor_value(id)
      {
            $.ajax({
                 url:"../../Controller/doora_dollor_value/editdoora_dollor_value.php?id="+id,
                 method:"POST",
                 success:function(data)
                 {
                      $('.content-wrapper').html(data);
                ...
                {                    
                  ?> <tr>
                                ...
                                <td style="text-align:center;">
                                    <div>
                                        <a onclick="editdoora_dollor_value(<?php echo $data['id']; ?>)" <?php //echo "href=../../Controller/tag/edittag_controller.php?id=".$data['tag_id']; ?> title="Edit" style="cursor: pointer;" >
                                          <i class="fa fa-pencil-square-o fa-fw"></i>
                                        </a>
                                        <!-- <a onclick="JSconfirm(<?php echo $data['id']; ?>)" <?php //echo "href=../../Controller/tag/deletetag_controller.php?id=".$data['tag_id'];?>  title="Delete" style="cursor: pointer;">
                                        <i class="fa fa-trash-o fa-fw"></i>
                                        </a>
                                        <a onclick="viewtag(<?php echo $data['id']; ?>)" title="View all detail" style="cursor: pointer;">
                                          <i class="fa fa-eye"></i>
                                    </a> -->
                                  </div>
                                </td>

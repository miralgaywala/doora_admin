        			...
        			<div class="box-body">
        				<form class="form-horizontal" name="addtag" id="addtag" role="form" action="" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <textarea name="points_offer_desc" type="text" id="points_offer_desc" class="form-control"/></textarea>
                            ...
                            <div class="form-group notranslate">
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                   <input type="checkbox" name="is_fixed_points" id="is_fixed_points" value="0">
                            ...
                            <div class="form-group notranslate">
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <input name="points_number" type="number" id="points_number" class="form-control" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="0" readonly/>
                             ...
                             <div class="form-group notranslate">
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <input name="multipliers_points" type="number" id="multipliers_points" class="form-control" step="1" min="1" value="1" />
                             ...
                             <div class="form-group notranslate">
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <input name="number_of_purchase_offer" type="number" id="number_of_purchase_offer" class="form-control" step="1" min="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="1"/>
                           ...
                           <div class="form-group notranslate">
                            ...
                            <div class="form-group notranslate">
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <input name="offer_start_date" type="text" id="offer_start_date" class="form-control"/>
                            ...
                            <div class="form-group notranslate">
                                ...
                                <div class="col-sm-8" style="padding-top: 6px">
                                    <input name="offer_end_date" type="text" id="offer_end_date" class="form-control"/>

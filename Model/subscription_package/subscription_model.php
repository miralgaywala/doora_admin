...
class subscription_model
{
    ...
    public function addsubscription_data($price,$per_deal_redeem_price,$free_days)
    {
      ...
      $date=$date->format('y-m-d H:i:s');
        ...
        {
      $subscription=$con->query("insert into subscription_plans (price,per_deal_redeem_price,free_days,created_at) values(".$price.",".$per_deal_redeem_price.",".$free_days.",'".$date."')"); 
      $addsubscription="1"; 
      }  

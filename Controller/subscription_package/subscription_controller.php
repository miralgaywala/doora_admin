<?php 
include_once($_SERVER['DOCUMENT_ROOT']."/doora/adminpanel/Model/subscription_package/subscription_model.php");
class subscription_controller
{
	...
	public function display_subscription($msg)
	{
		...
		include_once($_SERVER['DOCUMENT_ROOT'].'/doora/adminpanel/View/subscription_package/displaysubscription.php');
	...
	public function add_subscription()
	{
		if(isset($_POST['subscription_submit']) && !empty($_POST['subscription_submit']))
		{
			...
			{
			echo '<script>window.location.href="/doora/adminpanel/Controller/subscription_package/displaysubscription_controller.php?id=0";</script>';
			}
			else
			{
	...
	public function editlist_subscription($subscription_id)
	{
		...
		include_once($_SERVER['DOCUMENT_ROOT'].'/doora/adminpanel/View/subscription_package/editsubscription.php');
	...
	public function edit_subscription()
	{
		if(isset($_POST['subscription_submit']) && !empty($_POST['subscription_submit']))
		{
			...
			{
			echo '<script>window.location.href="/doora/adminpanel/Controller/subscription_package/displaysubscription_controller.php?id=2";</script>';
			}
			else
			{
					echo '<div class="alert alert-info alert-dismissible">
	...
	public function delete_subscription($subscription_id)
	{
		...
		echo '<script>window.location.href="/doora/adminpanel/Controller/subscription_package/displaysubscription_controller.php?id=3";</script>';
	}
	public function view_subscription($subscription_id)
	{
		...
		include_once($_SERVER['DOCUMENT_ROOT'].'/doora/adminpanel/View/subscription_package/viewsubscription.php');
